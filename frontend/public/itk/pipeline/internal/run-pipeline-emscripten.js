                    ...
                    transformList.forEach((transform, transformIndex) => {
                        ...
                        if (transform.numberOfFixedParameters > 0) {
                            transformList[transformIndex].fixedParameters =
                                getPipelineModuleOutputArray(pipelineModule, index, outputArrayIndex, FloatTypes.Float64);
                        }
                        outputArrayIndex += 1;
                        if (transform.numberOfParameters > 0) {
                            transformList[transformIndex].parameters =
                                getPipelineModuleOutputArray(pipelineModule, index, outputArrayIndex, transform.transformType.parametersValueType);
                        }
                        outputArrayIndex += 1;
                    });
